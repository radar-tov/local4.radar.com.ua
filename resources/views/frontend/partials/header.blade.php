    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m4 l2 contacts">
                ...
                <a href="mailto:house.od@gmail.com"><span class="mail">{{ array_get($settingsProvider->getSettings(),'contact_email') }}</span></a>
                @endif
            </div>
            <div class="col s12 m4 l2 links">
                        <span><a href="#callorder" class="modal-trigger"><i class="fa fa-phone green-text"></i>Заказать звонок</a></span><br>
