<div class="col s12 m4 l4 item-inner">
    <div class="card item itemAnim{{ $product->id }}">
        ...
        @if($product->category)
		<div class="linkProduct" onclick="return location.href = '/{{ $product->category->parent->slug }}/{{ $product->category->slug }}/{{ $product->slug}}'">
            ...
            @else
                <div class="item-content"><span class="hover-price">{{ $product->getPrice() }} грн</span></div>
