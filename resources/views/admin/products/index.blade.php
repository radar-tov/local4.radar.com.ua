            ...
            <table id="sample-table-2" class="table table-bordered table-hover" v-show="!loader">
                ...
                <tr v-repeat="product in products.productList" v-on="click:chengeColor()">
                    ...
                    <td class="p-title">
                        ...
                        <a style="color: #000000" target="_blank" href="/dashboard/products/@{{ product.id }}/edit" v-if="product.name != null">
                            @{{ product.name }}
                        </a>
                        <a style="color: #000000" target="_blank" href="/dashboard/products/@{{ product.id }}/edit" v-else>
                            @{{ product.title }}
                        </a>
