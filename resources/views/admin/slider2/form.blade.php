<div class="col-lg-8">
    ...
    <div class="form-group">
        ...
        {!! Form::text('subtitle',$value = null,['placeholder'=>'Подзаголовок','class'=>'form-control']) !!}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="slider-box">
            @if(is_file($slider->thumbnail))
                <img src="{!! asset($slider->thumbnail) !!}" alt=""/>
            @endif
        </div>
        {!! Form::hidden('thumbnail',$slider->thumbnail, ['id'=>'thumbnail']) !!}
    </div>
</div>
<div class="col-lg-4">
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="btn-group" data-toggle="buttons">
            <label class="btn btn-primary {{ $slider->show == 1 ? 'active' : null }}">
                {!!Form::radio('show',$value = 1, $slider->show == 1 ? true : false)!!}Да</label>
            <label class="btn btn-primary {{ $slider->show == 0 ? 'active' : null }}">
                {!!Form::radio('show',$value = 0, $slider->show == 0 ? true : false)!!}Нет</label>
        </div>
    </div>
