<div id="sidebar" class="sidebar menu-min responsive">
    ...
    <ul class="nav nav-list">
        ...
        <li class="{{ Request::is('dashboard/shipments*') ? 'active' : null }} highlight hover">
            ...
            <b class="arrow"></b>
            <ul class="submenu">
                <li class="{{ Request::is('dashboard/novaposhta*') ? 'active' : null }} highlight">
        ...
        <li  class="{{ Request::is('dashboard/sliders*') ? 'active' : null }} highlight hover">
            <a href="#">
            ...
            <b class="arrow"></b>
            <ul class="submenu">
                <li  class="{{ Request::is('dashboard/sliders*') ? 'active' : null }} highlight">
                ...
                <li  class="{{ Request::is('dashboard/slider2*') ? 'active' : null }} highlight">
