...
if(document.getElementById('values')) {
    var Values = new Vue({
        ...
        methods: {
            ...
            updateList:function(){
                var vue = this,
                    uri = '/dashboard/characteristics_value/'+ vue.filterId +'/characteristics';
            ...
            saveValue: function(){
                ...
                var vue = this,
                    ...
                    uri = '/dashboard/characteristics_value',
                    data;

                if(this.newValue.length && ! state){
                    data = {
                        characteristic_id: vue.filterId,
                        value: vue.newValue
                    };
                    ...
                    uri = '/dashboard/characteristics_value/' + vue.fieldsForUpdate.id + '';
                    data = {
                        value:vue.newValue
                    };
            ...
            removeValue: function(event,value){
                event.preventDefault();
                var vue = this,
                    uri = '/dashboard/characteristics_value/' + value.id +'',
                    data = {};
